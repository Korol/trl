...
var CONST_AJAX_URL = '/cabinet/ajax-0-0-3?typecabinet=' + readCookie('typecabinet') + '&colorcabinet=' + readCookie('colorcabinet') + '&id=';
...
function setDefault(kitchenID) {
    ...
    $('.colors ul li:first-child div').each(function () {
        ...
        // уже были тут картинку выбирали??
        //alert(readCookie('imgnuminlistcabinet'));
        if (readCookie('imgnuminlist_door')) {
            idColor = readCookie('imgnuminlist_door');
        }
        findColor(kitchenID, i, idColor);
        $('#' + CONST_FIELD_TYPE + i).val(idColor);
        ...
        // уже были тут картинку выбирали??
        //alert(readCookie('imgnuminlistcabinet'));
        if (readCookie('imgnuminlist_handle')) {
            idColor = readCookie('imgnuminlist_handle');
        }
        findColor(kitchenID, i, idColor);
        $('#' + CONST_FIELD_TYPE + i).val(idColor);
        ...
        // уже были тут картинку выбирали??
        //alert(readCookie('imgnuminlistcabinet'));
        if (readCookie('imgnuminlist_border')) {
            idColor = readCookie('imgnuminlist_border');
        }
        findColor(kitchenID, i, idColor);
        $('#' + CONST_FIELD_TYPE + i).val(idColor);
