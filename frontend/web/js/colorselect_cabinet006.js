...
var CONST_AJAX_URL = '/cabinet/ajax-0-0-6?typecabinet=' + readCookie('typecabinet') + '&colorcabinet=' + readCookie('colorcabinet') + '&type_door=' + readCookie('type_door') + '&color_door=' + readCookie('color_door') + '&id=';
...
function setDefault(kitchenID) {
  ...
  // первую фриз корниз и бордюр
        ...
        if (readCookie('imgnuminlist_border')) {
            idColor = readCookie('numimage_border');
        }
        findColor(kitchenID, i, idColor);
        $('#' + CONST_FIELD_TYPE + i).val(idColor);
