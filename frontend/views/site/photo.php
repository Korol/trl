...
$this->title = Yii::t('common', 'Shoot Photo');
...
<div class="site-signup">
  ...
  <div class="alert alert-info">Info! CHROME browser not supported for Photo by Webcam without HTTPS/SSL. Pls use Firefox browser for this page
</div>
<br>&nbsp;
<br>&nbsp;
<br>&nbsp;
...
';
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            ...
            <div id="results" class="well"><?= Yii::t('common', 'Your captured image will appear here...') ?><br></div>
            <p>
                <?php
            ...
            <a href="#" onclick="take_snapshot();return false;"
               class="btn btn-style-default"><?= Yii::t('common', 'Take Snapshot') ?></a>
