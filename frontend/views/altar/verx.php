        ...
        <div class="col-lg-5">
            <form method="POST">
                <div style="width:100%;position: relative;" class="div-class" id="div1" value="1">
                    <img src="/_altar/1/alt_verx_rez/verx1.png" class="img-view img-select" id="img1">
                    <input type="radio" name="<?=$var_name?>" checked="checked" value="1" style="position: absolute; top: 40px;left: 400px;">
                    <p style="position: absolute; top: 40px;left: 320px;">1</p>
                </div>
                <div style="width:100%;position: relative;" class="div-class" id="div2" value="2">
                    <img src="/_altar/1/alt_verx_rez/verx2.png" class="img-view" id="img2">
                    <input type="radio" name="<?=$var_name?>" value="2" style="position: absolute; top: 40px;left: 400px;">
                    <p style="position: absolute; top: 40px;left: 320px;">2</p>
                </div>
                <div style="width:100%;position: relative;" class="div-class" id="div2" value="3">
                    <img src="/img/pix.png" class="img-view" id="img3" style="height: 96px;">
                    <input type="radio" name="<?=$var_name?>" value="3" style="position: absolute; top: 40px;left: 400px;">
                    <p style="position: absolute; top: 45px;left: 190px;color:#000;">ללא</p>
                </div>

                <a href="/altar/page7"><img src="/img/back.png" title="<?=Yii::t('common', 'Back')?>" style="width: 45px;margin-left: 110px;"></a>
