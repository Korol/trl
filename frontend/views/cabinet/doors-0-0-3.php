        ...
        <div class="col-lg-6">
            ...
            <div class="myform">
                <form method="POST">
                    ...
                    <a href="/cabinet/shelmounting-0-0-5"><img src="/img/back.png" title="<?=Yii::t('common', 'Back')?>" style="width: 45px;"></a>
...
<script>
    $(document).ready(function()
    {
        if(readCookie('typecapitel') && readCookie('typecapitel')!='none')
            $('#layer10').html('<img src="/_cabinet/<?=$_COOKIE['numsections']?>/frieze/frieze1k_<?=$_COOKIE['numsections']?>_<?=$_COOKIE['colorcabinet']?>.png">');
    });
</script>